#!/usr/bin/env python3
"""
s03_todo_write_ollama.py - TodoWrite (Ollama version)

Same TodoManager + nag reminder pattern as s03_todo_write.py
...
# -- Agent loop with nag reminder (OpenAI format) --
def agent_loop(messages: list):
    ...
    while True:
        ...
        # Nag reminder: in OpenAI format, inject as a follow-up user message
        if rounds_since_todo >= 3:
...
if __name__ == "__main__":
    ...
    while True:
        try:
            query = input("\033[36ms03-ollama >> \033[0m")
