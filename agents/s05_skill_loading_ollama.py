#!/usr/bin/env python3
"""
s05_skill_loading_ollama.py - Skills (Ollama version)

Same two-layer skill injection as s05_skill_loading.py but uses
...
if __name__ == "__main__":
    ...
    while True:
        try:
            query = input("\033[36ms05-ollama >> \033[0m")
