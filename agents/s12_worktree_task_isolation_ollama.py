#!/usr/bin/env python3
"""
s12_worktree_task_isolation_ollama.py - Worktree + Task Isolation (Ollama version)

Same WorktreeManager, TaskManager, EventBus as s12_worktree_task_isolation.py
...
# -- WorktreeManager: identical to s12 --
...
if __name__ == "__main__":
    ...
    while True:
        try:
            query = input("\033[36ms12-ollama >> \033[0m")
