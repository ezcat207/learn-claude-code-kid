#!/usr/bin/env python3
"""
s07_task_system_ollama.py - Tasks (Ollama version)

Same TaskManager + dependency graph as s07_task_system.py but uses
...
if __name__ == "__main__":
    ...
    while True:
        try:
            query = input("\033[36ms07-ollama >> \033[0m")
